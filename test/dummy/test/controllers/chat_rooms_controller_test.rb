...
class ChatRoomsControllerTest < ActionController::TestCase
  ...
  test "should create chat_room" do
    assert_difference('ChatRoom.count') do
      post :create, chat_room: { customer_name: @chat_room.customer_name, duration: @chat_room.duration, order: @chat_room.order, performer_name: @chat_room.performer_name, type: @chat_room.type }
    end
  ...
  test "should update chat_room" do
    patch :update, id: @chat_room, chat_room: { customer_name: @chat_room.customer_name, duration: @chat_room.duration, order: @chat_room.order, performer_name: @chat_room.performer_name, type: @chat_room.type }
    assert_redirected_to chat_room_path(assigns(:chat_room))
  end
